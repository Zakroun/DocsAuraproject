  ...
  return (
    <div className="profile">
      <div className="part1">
        ...
        <div className="stars">{generateStars(laboratory.rating)}</div>
        <div className="comments">
          {laboratory.comments.map((c) => {
            return (
      ...
      <div className="part2">
        <div className="informationslaboratory">
          <div className="head">
            ...
            <Link to={`/pages/reservelabo`} state={{id : laboratory.id , role : laboratory.Role}}>
          ...
          <p>
            Email : {laboratory.email} / Phone : {laboratory.phone}
          </p>
          <p className="specialty">{laboratory.description}</p>
          <p className="specialty">Services :</p>
          <ul>
            {laboratory.services.map((a, k) => {
